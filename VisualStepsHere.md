...
### 8. Create a directory called "game-day-notifications" to make copy of my repository inside of it.
...
### 9. To create an SNS Topic, open the AWS Management Console and navigate to the SNS service.
...
### 10. Click Create Topic and select Standard as the topic type.
...
### 11.Select Standard and Name the topic (e.g., gd_topic) , then click "Create Topic
...
### 12. Take note of the ARN, you will need to use it later.
...
### 13. Scroll down to "Subcriptions" and click "Create subscriptions".
...
### 14. After creating the topic, to add subscriptions, scroll down to "Subscriptions" tab and click Create subscription. (if you have other SNS 
...
### 15. Scroll down and click "Create Subscription" on the bottom right.
...
### 16. If you added an Email subscription:
...
### 17. For SMS (text messages), the subscription will be immediately active after creation.
...
### 18. On the AWS page you have open, click "gd_topic" on the top path to validate your confirmed subcription. 
...
### 19. Next you will create the SNS Publish Policy. Open the IAM service in the AWS Management Console.
...
### 20. On the left panel, navigate to Policies, then click "Create Policy" on the top right.
...
### 21. Select the SNS service uner "Select a serivice".
...
### 22. Click "JSON" tab and paste the JSON policy from gd_sns_policy.json file (the file is located in my github or your account if it was cloned). After tasks are completed click "Next".
...
### 23. Enter copied script in policy editor.
...
### 24. Click Next: Tags (you can skip adding tags).
...
### 25. Enter a name for the policy (e.g., gd_sns_policy).
...
### 26. Review and click Create Policy.
...
### 27. Next you will create an IAM Role for Lambda. To do this, Open the IAM service in the AWS Management Console.

&nbsp;

&nbsp;

### 28. On the left Click "Roles", then click "Create role" on the top right.
...
### 29. Select "AWS Service" for your "Trusted enitity type", and choose "Lambda" for your Use case.
...
### 30. Select the following policies:
...
### 31. Click Next: Tags (you can skip adding tags).
Click Next: Review.
...
### 33. Next you will Deploy the Lambda Function, open the AWS Management Console and navigate to the Lambda service.
...
### 35. Select the "Author from scratch", enter a "function name" (e.g., gd_notifications), choose Python 3.x as the runtime, and "Architecture" 
...
### 36. Under "Execution role" select "Use an existing role". Assign the IAM role created earlier (gd_lambda_role) to the function "Existing 
...
### 37. Scroll down to the function "Code" tab.
...
### 38. copy the contents of the src/gd_notifications.py file from the repository and paste it 
    in the code funtion. 
...
### 39. You can adjust the timezone if you needed in this script. To change timezone, figure out what number is needed for the timezone in 
 this script. I researched my timezone and it is "5" for Eastern.
...
### 42. Next, go to "Configuration" tab, then click "Environment Variables" on the left panel. 
...
### 43. Click "Add environment variable", then add the "Key" name (API Key) and "Value" (API Key).
...
### 44. Click "Add environment variable" to add a second variable. Add the "Key" name (SNS Topic) and "Value" (ARN of SNS topic created earlier).  After you enter both Variables click "Save" and "Create function"
...
### 45.You will now have to Set Up Automation with Eventbridge, navigate to the Eventbridge service in the AWS Management Console.
...
### 46. On the Left panel click to "Rules" , then click "Create Rule".
...
### 47. Test the system to validate it works, click the "Test" tab.
...
### 48. For the "Event name", name it “test1”, and click save. Leave everything else at the default settings.
...
### 49. After you click "Save" click "Test" on top right. Wait about 3-6 seconds to validate test was successful.
...
### 50. You will recieve a notification in your email. Open the email to validate you recieved some game statuses.
...
### 51. Go to "Amazon EventBridge" service to set the cron schedule for when you updates (e.g., hourly).
...
### 52. Scroll down and click "Create rule"
...
### 53. For the "Name" enter "gd_rule", for the "Rule type" select "Schedule", then click "Continue in EventBridge Scheduler".
...
#### 54. Scroll down to "Schedule pattern", then select "Recurring schedule" and "Cron-based schedule".
...
### 55. Enter "Cron expression" for your schedule, you can get help to generate an Cron expression on chatGPT or any website you can research 
...
### 56. Scroll down to "Select target" and select "AWS Lambda".
...
### 57. Scroll down to "Invoke" and  select the "Lambda function", "gd_notifications",
...
### 58. Validate the  "Schedule state" is enabled, and under "Permissions" the "Execution role" is set to “Create new role for this schedule” (this should be default settings), then click next.
...
### 59. Scroll down and click "create schedule" on the bottom right.
...
### 60. Scroll down to "gd_rule" and validate the "Status" is "Enabled. 
